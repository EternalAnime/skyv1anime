...
const APP_DEFAULT_TITLE = "SkyAnime - Watch Anime, Read Manga WITHOUT ADS for FREE!";
...
export default async function RootLayout({ children }) {
  ...
  gtag('config', 'G-TYKL9CYSFS');`}
      ...
      <script
        ...
        <link rel="apple-touch-icon" sizes="180x180" href="https://raw.githubusercontent.com/EternalAnime/skyv1anime/main/public/apple-touch-icon.png" />
        <link rel="icon" type="image/png" sizes="192x192" href="https://raw.githubusercontent.com/EternalAnime/skyv1anime/main/public/android-chrome-192x192.png" />
