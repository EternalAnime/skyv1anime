    ...
    <div>
      ...
      <div className="mx-auto w-[94%] lg:w-[80%]">
        ...
        <p className="mt-4 text-[#bdbdbd]">
          Skyanime.co is committed to respecting the intellectual property
        ...
        <p className="mt-4 text-[#bdbdbd]">
          None of the files listed on skyanime.co are hosted on our servers. All
          links point to content hosted on third-party websites. skyanime.co does
          ...
          to{" "}
          <Link href="mailto:support@skyanime.co" className="text-white">
            support@1anime.co
          </Link>{" "} or visit support.skyanime.co
